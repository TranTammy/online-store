...
CREATE TABLE `employee` (
    ...
    CONSTRAINT `employee_dept_id` FOREIGN KEY (`dept_id`) REFERENCES `department` (`dept_id`)
...
CREATE TABLE `employee_credentials` (
    ...
    CONSTRAINT `employee_ssn` FOREIGN KEY (`employee_ssn`) REFERENCES `employee` (`employee_ssn`)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `employee_username` FOREIGN KEY (`username`) REFERENCES `employee` (`username`)
        ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE `product` (
    ...
    CONSTRAINT `product_dept_id` FOREIGN KEY (`dept_id`) REFERENCES `department` (`dept_id`)
        ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE `cart` (
    ...
    CONSTRAINT `customer_cart_id` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `product_cart_id` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`)
        ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE `supplier_products` (
    ...
    CONSTRAINT `product_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`supplier_id`)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `supplied_product_id` FOREIGN KEY (`supplier_product_id`) REFERENCES `product` (`product_id`)
        ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE `supplied_by` (
    ...
    CONSTRAINT `supplied_by_id` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`supplier_id`)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `product_supplied_id` FOREIGN KEY (`store_product_id`) REFERENCES `product` (`product_id`)
        ON DELETE CASCADE ON UPDATE CASCADE
);
