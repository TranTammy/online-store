...
CREATE TABLE IF NOT EXISTS `product` (
	...
	CONSTRAINT `product_dept_id` FOREIGN KEY (`dept_id`) REFERENCES `department` (`dept_id`) ON DELETE SET DEFAULT ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `supplier_products` (
	...
	CONSTRAINT `product_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`supplier_id`) ON DELETE SET DEFAULT ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `supplied_by` (
	...
	CONSTRAINT `supplied_by_id` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`supplier_id`) ON DELETE SET DEFAULT ON UPDATE CASCADE,
	CONSTRAINT `product_supplied_id` FOREIGN KEY (`store_product_id`) REFERENCES `product` (`product_id`) ON DELETE SET DEFAULT ON UPDATE CASCADE
);
